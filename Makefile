#############################################################################
# Makefile for building: MyFirstApp
# Generated by qmake (3.0) (Qt 5.0.2) on: Fri Mar 7 22:11:14 2014
# Project:  MyFirstApp.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile MyFirstApp.pro
#############################################################################
...
Makefile: MyFirstApp.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile MyFirstApp.pro
...
dist: 
	@test -d .tmp/MyFirstApp1.0.0 || mkdir -p .tmp/MyFirstApp1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/MyFirstApp1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/MyFirstApp1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/MyFirstApp1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/MyFirstApp1.0.0/ && (cd `dirname .tmp/MyFirstApp1.0.0` && $(TAR) MyFirstApp1.0.0.tar MyFirstApp1.0.0 && $(COMPRESS) MyFirstApp1.0.0.tar) && $(MOVE) `dirname .tmp/MyFirstApp1.0.0`/MyFirstApp1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/MyFirstApp1.0.0
